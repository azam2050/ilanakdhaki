            ...
            {[
              {
                ...
                desc: "للبدايات",
                features: [
                  "ربط منصتين إعلانيتين (سناب، ميتا، تيك توك أو جوجل)",
                  "مسوّقك الذكي يعمل تلقائياً ٢٤/٧",
                  "تقرير يومي بالعربي",
                  "نصائح يومية + فيديو اليوم",
                  "تجربة مجانية ٣٠ يوم بدون بطاقة",
                ],
              },
              {
                name: "النمو",
                ...
                desc: "الأكثر طلباً",
                features: [
                  "ربط كامل لكل المنصات الأربع (سناب + ميتا + تيك توك + جوجل)",
                  "مسوّقك الذكي يعمل تلقائياً ٢٤/٧",
                  "تقرير كل ٦ ساعات",
                  "نصائح يومية + فيديو اليوم",
                  "مكتبة إعلانات كاملة",
                  "تحليل فيديو مدروس",
                  "تنبيهات المواسم مبكراً",
                  "تجربة مجانية ٣٠ يوم بدون بطاقة",
                ],
                highlight: true,
              },
              {
                ...
                features: [
                  "كل مزايا النمو",
                  "الاستهداف الذكي المتقدم — إعلانك يوصل لمن هو جاهز يشتري الآن",
                  "نبض السوق هذا الأسبوع — تقرير عن حركة فئتك",
                  "تقرير أسبوعي تفصيلي PDF",
                  "توصيات موسمية مبكرة قبل ٣٠ يوم",
                  "مكتبة إعلانات غير محدودة",
                  "أولوية في تحليل الفيديو",
                  "تجربة مجانية ٣٠ يوم بدون بطاقة",
                ],
              },
            ].map((p, i) => (
